...
//В этом случае, если массив имеет меньше 9 элементов, программа сообщает, что не удается вычислить выражение, так как
// в массиве нет 8-го элемента.
//Если d равно 0:
//It's not possible to evaluate the expression - intArray[8] / d as d = 0.
...
class Expr {
    public static double expr(int[] intArray, int d) {
        try {
            System.out.printf("intArray[8] / d = %d / %d = " + intArray[8] / d * 1.0, intArray[8], d);
            System.out.println();
